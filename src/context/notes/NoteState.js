...
return (
  <noteContext.Provider value={{ notes: notes, getnotes: getnotes, setnotes: setnotes, title, description, titlechange, descriptionchange, subClicked, addnote, deleteclicked, etitle, edescription, etitlechange, edescriptionchange, editclicked, ref, saveclicked, getuser, user }}>
    {props.children}
